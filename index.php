...
<b><a class="navbar-brand" href="#"><i class="fas fa-hamburger">OFO</i></a></b>
...
<div class="container pt-5">
  <div class="row ">
    ...
    <div><h5 >Follow Us</h5></div><br>
      <div class="row">
      <button class="btn btn-warning ml-3"><i class="fab fa-facebook"></i></button>&nbsp;
      <button class="btn btn-warning"><i class="fab fa-youtube"></i></button>&nbsp;
      <button class="btn btn-warning"><i class="fab fa-twitter"></i></button>&nbsp;
      <button class="btn btn-warning"><i class="fab fa-google-plus-g"></i></button>
      </div>
    </div>
    <div class="col-lg-4 col-md-4 col-12 pt-3">
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d38261.75285583098!2d72.97203202117096!3d19.162999656687287!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7bf523dd8b5ab%3A0x9de9a7f73961da61!2sAiroli%2C%20Navi%20Mumbai%2C%20Maharashtra%20400708!5e0!3m2!1sen!2sin!4v1617435171021!5m2!1sen!2sin" width="100%" height="300" style="border: 0px;" allowfullscreen frameborder="1" loading="lazy"></iframe>
    </div>
  </div>
</div>     
...
<div class=" text-center text-white bg-secondary p-2 "><p>Copyright &copy;2021 All rights reserverd | Designed by Harikesh </p></div>
</footer>
