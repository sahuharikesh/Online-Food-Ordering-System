...
<body>
 ...
 <p class="text-center"><i class="fa fa-user-secret text-warning mx-2"></i>Admin Login Area </p>  
 <div class="container-fluid">
    <div class="row justify-content-center mt-5">
        ...
        <form action="" method="POST" class="shadow-lg px-4 py-5 "autocomplete="off">
            ...
            <button type="submit" class="btn btn-warning mt-5 btn-block shadow-sm font-weight-bold " name="aSignup">Login</button>
