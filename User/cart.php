...
<div class="container-fluid">
    <div class="row px-5">
        <div class="col-md-7">
            ...
            <div class="row ">
               <a href="order.php" ><button type="submit" class="btn btn-warning "><i class="fas fa-arrow-alt-circle-left">&nbsp;</i>Go Back..</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <h5> My Cart</h5>
            </div>
                <hr>
                ...
                if($result->num_rows > 0){
                    ...
                    foreach ($_SESSION['cart'] as $a){
                        if ($row['id'] == $a['product_id']){
                            ...
                            <button type="submit" class="btn btn-warning " name="save">Add More</button>
    ...
    <div class="row price-details">
        ...
        <div class="col-md-6">
            ...
            <h6>$<?php echo $total; ?></h6>
                ...
                <button type="submit" class="btn btn-warning" name="addProd" >Checkout</button>
            </form><br>
        </div>
       </div>
   </div>
