...
<body class="hero-image">
 ...
 <div class="container-fluid text-white">
    <div class="row justify-content-center mt-3">
        ...
        <i class="fa fa-user-circle fa-4x text-warning mx-2"></i >
        ...
        <button type="submit" class="btn btn-warning mt-5  btn-block shadow-sm font-weight-bold " name="rSignup">Login</button>
